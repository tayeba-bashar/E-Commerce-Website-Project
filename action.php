			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.bkash.com/app/" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
									...
									<input style="float:right; margin-right:80px; width: 100px; height: 100px" type="image" name="submit"
										src="https://play-lh.googleusercontent.com/UWIyHqi_5u5oyiKB7NyuCL-YYDujSKWOkfFnziLm8cGSMWb094MRXMwXEm4Ew6iy6nA=s180-rw" alt="bKash Checkout"
										alt="bKash">
